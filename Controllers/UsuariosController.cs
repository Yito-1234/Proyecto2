...
namespace Order2GoV2.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["IdPerfil"] = new SelectList(_context.Perfils, "IdPerfil", "Nombre");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdUsuario,Nombre,Apellidos,UserName,Clave,IdPerfil")] Usuario usuarios)
        {
            if (!ValidarUsuarioAdmin())
                return RedirectToAction("Login", "Login");
            ...
            ViewData["IdPerfil"] = new SelectList(_context.Perfils, "IdPerfil", "Nombre", usuarios.IdPerfil);
            return View(usuarios);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,Nombre,Apellidos,UserName,Clave,IdPerfil")] Usuario usuarios)
        {
            if (!ValidarUsuarioAdmin())
                return RedirectToAction("Login", "Login");
