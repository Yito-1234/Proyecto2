...
namespace Order2GoV2.Controllers
{
    public class ComerciosController : Controller
    {
        ...
        public ComerciosController(Order2GoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.AfiliacionComercios.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var comercio = await _context.AfiliacionComercios
        ...
        public async Task<IActionResult> Create([Bind("IdComercio,Nombre,Decripcion,Telefono")] AfiliacionComercio comercio)
        {
            if (!ValidarUsuarioAdmin())
                return RedirectToAction("Login", "Login");
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var comercio = await _context.AfiliacionComercios.FindAsync(id);
            if (comercio == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdComercio,Nombre,Decripcion,Telefono")] AfiliacionComercio comercio)
        {
            if (!ValidarUsuarioAdmin())
                return RedirectToAction("Login", "Login");
        ...
        {
            return _context.AfiliacionComercios.Any(e => e.IdComercio == id);
        }
    }
}
